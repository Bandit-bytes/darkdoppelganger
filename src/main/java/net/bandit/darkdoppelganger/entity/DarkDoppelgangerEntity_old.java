...
public class DarkDoppelgangerEntity_old extends AbstractSpellCastingMob implements Enemy, IAnimatedAttacker {
    ...
    public DarkDoppelgangerEntity_old(EntityType<? extends AbstractSpellCastingMob> type, Level world) {
        super(type, world);
...
//    }
    ...
    private final AnimationController<DarkDoppelgangerEntity_old> meleeController = new AnimationController<>(this, "keeper_animations", 0, this::predicate);
    private final AnimationController<DarkDoppelgangerEntity_old> spawnController = new AnimationController<>(this, "spawn_animations", 0, this::spawnPredicate);
...
//            DarkDoppelgangerMod.LOGGER.error("Entity {} Failed to play animation: {}", this, animationId);
    ...
    private PlayState predicate(AnimationState<DarkDoppelgangerEntity_old> animationEvent) {
    ...
    private PlayState spawnPredicate(AnimationState<DarkDoppelgangerEntity_old> animationEvent) {
        var controller = animationEvent.getController();
